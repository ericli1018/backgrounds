...
if (CKEDITOR.skins) {
    ...
    CKEDITOR.plugins.setLang('backgroundPosition', 'en', { backgroundPosition: { label: 'Background position'} });
}
else {
    // V4
    ...
    CKEDITOR.plugins.setLang('backgroundPosition', 'en', { label: 'Background position' });
}